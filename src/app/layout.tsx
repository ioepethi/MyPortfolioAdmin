...
const description =
  "Office Admin & Admin Assistant in Dubai with 5+ years in administration, operations, reporting, documentation, and IT support. Open to opportunities across the UAE.";
const keywords = [
  "Office Admin Dubai",
