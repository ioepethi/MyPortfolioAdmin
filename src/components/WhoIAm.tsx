    ...
    <DropdownSection id="who" index="01" title="Who I Am" theme="light">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
        ...
        <div id="who-about" className="scroll-mt-24 lg:col-span-6">
          ...
          <p className="mt-7 inline-block border border-[var(--line-strong)] px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.14em]">
            {profile.tagline}
          </p>
        </div>
        ...
        <div className="space-y-8 lg:col-span-6">
          <div id="who-mission" className="scroll-mt-24 border-l-2 border-[var(--color-green)] pl-5">
            ...
            <p className="mt-3 text-base font-bold uppercase leading-snug tracking-tight sm:text-lg">
