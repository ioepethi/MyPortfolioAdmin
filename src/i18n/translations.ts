...
export const translations = {
  en: {
    ...
    about: {
      ...
      aiIntro:
        "I'm also completing a full AI Automation program, where I'm building practical, agency-style AI systems across a range of industries, including:",
      aiPoints: [
        ...
        "AI Bookkeeping & Finance Assistant",
        "AI Document & SOP Agency",
        "AI Proposal & Tender Agency",
        "AI Training Agency",
        "AI IT Helpdesk Agency",
        "And many more",
      ],
      aiTools: "I build these systems using n8n, Claude, Devin, and other AI automation tools.",
    },
    skills: {
  ...
  fil: {
    ...
    about: {
      ...
      body: "Isang Administrative & Operations Professional na may 4+ taong karanasan sa administrasyon, operasyon, at IT support sa UAE at Pilipinas. May pag-iingat sa responsibilidad, malakas na pananagutan, at pagmamalasakit sa pagpapabuti ng proseso, pagtulong sa tagumpay ng koponan, at pagbibigay ng mahusay na operasyon.",
      ...
      aiHeading: "Kasalukuyang gumagawa gamit ang AI automation",
      aiIntro:
        "Kasalukuyan ko ring tinatapos ang isang full AI Automation program, kung saan gumagawa ako ng praktikal na AI system na parang ahensya sa iba't ibang industriya, kabilang ang:",
      aiPoints: [
        "AI Automation para sa Marketing Agencies",
        "AI Virtual Assistant Agency",
        "AI Recruitment Agency",
        "AI Customer Service Agency",
        "AI Lead Generation Agency",
      ...
      aiTools: "Ginagawa ko ang mga system na ito gamit ang n8n, Claude, Devin, at iba pang AI automation tools.",
    },
    skills: {
